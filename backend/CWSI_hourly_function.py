# # -*- coding: utf-8 -*-
# """
# Created on Mon Jun 27 17:38:38 2022
# Function testing
# @author: lxh4557
# """
...
# def CWSI_plot(df, day, compute_delta_bar = True, compute_Rnc_bar = True, compute_a_reg = True, compute_b_reg = True, compute_ra_bar = True, compute_rc_bar = True, compute_rho_bar = True, fixed = True):
...
#     plt.figure()
#     if fixed == True: 
#         plt.title("CWSI for day " + str(day) + ' fixed')
#     else:
#         plt.title("CWSI for day " + str(day) + ' no fix')
#     plt.plot(hours, cwsi_t, 'blue', label = "Theoretical")
#     plt.plot(hours, cwsi_e, 'r', label = "Emperical")
#     plt.legend()
#     plt.show()
    
#     return cwsi_e, cwsi_t

# ##### There are three treatments: 'SWB_40', 'SWB_65' and 'SWB_90'
# # df = treatment_selection(tc, cc, wx, 'SWB_40')
# # # cwsi_e1, cwsi__t1 = CWSI_plot(df, 173)
# # # cwsi_e2, cwsi__t2 = CWSI_plot(df, 173, False, False, False, False, False, False, False)
# # days = df.day.unique()
# # for day in days:
# #     cwsi_e1, cwsi__t1 = CWSI_plot(df, day, fixed= True)
# #     cwsi_e2, cwsi__t2 = CWSI_plot(df, day, False, False, False, False, False, False, False, False)

# ### Button 1
# # treatment = 'SWB_40'
# # df = treatment_selection(tc, cc, wx, treatment)

# # #### Button is the result of button 1
# # day = 174
# # cwsi_e1, cwsi__t1 = CWSI_plot(df, day, fixed= True)
# # cwsi_e2, cwsi__t2 = CWSI_plot(df, day, False, False, False, False, False, False, False, False)

# treatments = ['SWB_40', 'SWB_65','SWB_90']
